...
const userRecord = new ContainerModule((bind: interfaces.Bind, unbind: interfaces.Unbind) => {
  bind<IUserRecordRepository>(TYPES.UserRecordRepository).to(UserRecordRepository);
});
