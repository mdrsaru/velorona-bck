...
export class CreateWorkscheduleTable1656934177706 implements MigrationInterface {
  name = 'CreateWorkscheduleTable1656934177706';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
            ALTER TABLE "workschedule"
            ADD "payroll_allocated_hours" integer NOT NULL
        `);
    await queryRunner.query(`
            ALTER TABLE "workschedule"
