...
export class CreateTimeEntryTable1659286495908 implements MigrationInterface {
  name = 'CreateTimeEntryTable1659286495908';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "time_entries" (
                ...
                "entry_type" character varying NOT NULL DEFAULT 'Timesheet',
